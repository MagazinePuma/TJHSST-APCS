...
public class AreaFill
{
   ...
   public static void fill(char[][] g, int r, int c, char ch)
   {
      ...
      if(r >= g.length || r < 0 || c >= g[0].length || c < 0)
         return;
      ...
      fill(g, r-1, c, ch); //up
      fill(g, r+1, c, ch); //down
      fill(g, r, c-1, ch); //left
      fill(g, r, c+1, ch); //right
   }
   ...
   public static int fillAndCount(char[][] g, int r, int c, char ch)
   {
      ...
      count += fillAndCount(g, r-1, c, ch); //up
      count += fillAndCount(g, r+1, c, ch); //down
      count += fillAndCount(g, r, c-1, ch); //left
      count += fillAndCount(g, r, c+1, ch); //right 
