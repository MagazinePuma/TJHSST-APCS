...
class Widget implements Comparable<Widget>
{
   ...
   public boolean equals(Object arg){
      // Widget wArg = (Widget)(arg);
      if(arg instanceof Widget){
         return this.compareTo((Widget)(arg)) == 0;
         // return this.hashCode() == arg.hashCode();
      }
      return false; 
      //return this.compareTo(wArg) == 0;
      // if(arg instanceof Position){
      //    Widget wArg = (Widget)(arg);
      //    return myCubits == wArg.getCubits() && myHands == wArg.getHands();
      // } else {
      //    return false;
      // }
 ...
 /***** When hashCode() and equals() have been properly overridden, the output is  ***
 
 
 Widget equals String? false
 Widget equals Position? false
 -1226106435 -1226106435 -1226106435
 TreeSet:  [2 cubits 3 hands]
 HashSet:  [2 cubits 3 hands]
