...
public class Modes
{
   ...
   */
   ...
   {
      // Your code goes here.
      //return new int[] {2,4,11}; //just to make it compile
      if(tally.length == 1) {
         return new int[0];
      }
      ...
      int count = 0;
      int max = Modes.findMax(tally);
      int[] pModes = new int[tally.length/2];
      boolean isOnlyOneMode = true;
      ...
      int[] resultModes = new int[count];
      for(int i = 0; i < count; i++){
         resultModes[i] = pModes[i];
      }
