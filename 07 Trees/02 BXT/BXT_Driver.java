...
public class BXT_Driver
{
   ...
   //   
      ...
      // System.out.println( "\n------------------------");         
       ...
       /*  extension:  infix expression that matches the tree, minimal parentheses */
      //BXT tree2 = new BXT();
      //System.out.println("Extension.  Infix expression that matches the tree, minimal parentheses.");
      //tree2.buildTree("8 2 3 + +");   // "8 + ( 2 + 3 )"
